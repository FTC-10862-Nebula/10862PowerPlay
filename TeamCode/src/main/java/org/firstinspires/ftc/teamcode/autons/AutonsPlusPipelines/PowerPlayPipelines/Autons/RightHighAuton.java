package org.firstinspires.ftc.teamcode.autons.AutonsPlusPipelines.PowerPlayPipelines.Autons;
...
import org.firstinspires.ftc.teamcode.autons.AutonsPlusPipelines.PowerPlayPipelines.Commands.High.RightHighAutonCommand;
        ...
        switch (tagNum) {
            case 1: { //Left
                autonGroup = new SequentialCommandGroup(
                        new RightHighAutonCommand(drivetrain, slide, clawMotors, clawServos),
