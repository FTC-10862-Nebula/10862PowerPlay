...
public class SlowestDriveForwardCommand extends CommandBase{
    ...
    public SlowestDriveForwardCommand(MecanumDrive drive, double distance) {
        this.drive = drive;
    ...
    public SlowestDriveForwardCommand(MecanumDrive drive, double distance, MinVelocityConstraint constraint) {
        this.drive = drive;
        this.distance = distance;
