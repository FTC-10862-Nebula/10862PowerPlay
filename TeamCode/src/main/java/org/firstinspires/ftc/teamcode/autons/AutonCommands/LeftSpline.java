    ...
    public LeftSpline(Drivetrain drivetrain, Slide slide, Arm arm, Claw claw, TurnServo turnServo){
        ...
        addCommands(
                new ParallelCommandGroup(
                        ...
                        new SplineCommand(drivetrain, new Vector2d(58.3, -3.3), Math.toRadians(331))    //Cycle
                ),
                new DropAutoConeCommand(claw, slide, arm, true),
                new ParallelCommandGroup(
                        new PrePickB5Command(slide, claw, arm, turnServo),
                        new SplineCommand(drivetrain, new Vector2d(57, 24.5), Math.toRadians(90), true)   //Load
                ),
                ...
                new ParallelCommandGroup(
                        new SlideHighFCommand(slide, arm, claw, turnServo,true),
                        new SplineCommand(drivetrain, new Vector2d(58.3, -3.3), Math.toRadians(331), PoseStorage.cycle)    //Cycle
                ),
                new DropAutoConeCommand(claw, slide, arm, true),
                new ParallelCommandGroup(
                        new PrePickB5Command(slide, claw, arm, turnServo),
                        new SplineCommand(drivetrain, new Vector2d(57, 24.5), Math.toRadians(90), PoseStorage.load, true)   //Load
                ),
                new PickCBCommand(slide, claw)
