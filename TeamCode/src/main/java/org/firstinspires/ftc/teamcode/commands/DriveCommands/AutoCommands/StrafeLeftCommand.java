...
public class StrafeLeftCommand extends CommandBase{
    ...
    public StrafeLeftCommand(DrivetrainCOrrect drive, double distance) {
        this.drive = drive;
    ...
    public StrafeLeftCommand(DrivetrainCOrrect drive, double distance, MinVelocityConstraint constraint) {
        this.drive = drive;
        this.distance = distance;
