...
public class StrafeRightCommand extends CommandBase{
    ...
    public StrafeRightCommand(MecanumDrive drive, double distance) {
        this.drive = drive;
    ...
    public StrafeRightCommand(MecanumDrive drive, double distance, MinVelocityConstraint constraint) {
        this.drive = drive;
        this.distance = distance;
