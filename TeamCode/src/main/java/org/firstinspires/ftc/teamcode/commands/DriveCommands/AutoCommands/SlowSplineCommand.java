...
public class SlowSplineCommand extends CommandBase{
    ...
    public SlowSplineCommand(DrivetrainCOrrect drive, MinVelocityConstraint constraint, boolean reverse, Vector2d splinePos, double endHeading) {
        this.drive = drive;
    ...
    public SlowSplineCommand(DrivetrainCOrrect drive, Vector2d splinePos, double endHeading) {
        this(drive, Trajectories.kindaSlowVelConstraint, false, splinePos, endHeading);
    }

    public SlowSplineCommand(DrivetrainCOrrect drive, Vector2d splinePos, double endHeading, boolean reverse) {
