...
public class SlowDriveForwardCommand extends CommandBase{
    ...
    public SlowDriveForwardCommand(DrivetrainCOrrect drive, double distance) {
        this.drive = drive;
    ...
    public SlowDriveForwardCommand(DrivetrainCOrrect drive, double distance, MinVelocityConstraint constraint) {
        this.drive = drive;
        this.distance = distance;
